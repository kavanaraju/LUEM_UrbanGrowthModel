...
# 15A. Build trimmed 2021 census table with matching cell_id
...
# 15B. Assemble dat21: LC flags, infra+lag, census
lc2_df   <- fishnet_lc2 %>%
  st_drop_geometry() %>%
...
dat21 <- dat21 %>%
  mutate(
    pop21   = replace_na(pop21,   0),
    house21 = replace_na(house21, 0),
    inc21   = replace_na(inc21,   median(inc21, na.rm = TRUE))
  )

# Check no more NAs
cat("NAs in dat21:", sum(is.na(dat21)), "\n")

# 15D. Predict probabilities & binary outcome
...
# 15E. Join back to spatial fishnet
forecast_sf <- left_join(fishnet, dat21, by = "cell_id")

# 15F. Load and transform sensitive‐lands layers
...
# 15H. Summarize risk among predicted developments
...
knitr::kable(risk_sum, digits = 1,
             caption = "Percent of Predicted 2031 Cells at Risk")

# 15I. Map the 2031 forecast
ggplot(forecast_sf) +
  ...
  labs(
    ...
    caption  = "Scenario: New light-rail extension"
  ) +
  theme_void()
