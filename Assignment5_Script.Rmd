...
# Verify extent now matches study area
print(extent(lc_2011))
print(extent(lc_2021))
```
```{r}
writeRaster(
  x         = lc_2011,
...
new_corr <- st_read("data/LightRail_Extension/LightRail_Extension.shp") %>% st_transform(st_crs(fishnet))
